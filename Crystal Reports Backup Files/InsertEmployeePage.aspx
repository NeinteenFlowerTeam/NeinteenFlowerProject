<%@ Page Title="" Language="C#" MasterPageFile="~/View/Master.Master" AutoEventWireup="true" CodeBehind="InsertEmployeePage.aspx.cs" Inherits="NeinteenFlowerProject.View.AdminPage.ManageEmployee.InsertEmployeePage" %>
    ...
    <div class="container-form">
        <div class="form">
            ...
            <div>
                ...
                <asp:TextBox ID="passwordTxt" runat="server" type="password"  CssClass="textBox" placeholder="Enter your password"></asp:TextBox>
            ...
            <div>
                ...
                <asp:TextBox ID="nameTxt" runat="server" CssClass="textBox" placeholder="Insert your name"></asp:TextBox>
            ...
            <div>
                ...
                <asp:TextBox ID="phoneNumberTxt" runat="server" CssClass="textBox" placeholder="Enter your phone number" ></asp:TextBox>
            ...
            <div>
                <asp:Label ID="salaryLbl" runat="server" Text="Salary" CssClass="label"></asp:Label>
                <asp:TextBox ID="salaryTxt" runat="server" TextMode="Number" CssClass="textBox" placeholder="Enter your salary" ></asp:TextBox>
                <asp:Label ID="errorSalary" runat="server" Text="" CssClass="errLabel"></asp:Label>
            </div>
            <asp:Button ID="insertBtn" runat="server" Text="Insert" OnClick="insertBtn_Click" CssClass="welcomeBtn" />
        </div>
        <div class="img-insertEmployee"></div>
    </div>
</asp:Content>
