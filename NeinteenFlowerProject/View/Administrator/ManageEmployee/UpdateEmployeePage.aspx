<%@ Page Title="" Language="C#" MasterPageFile="~/View/Master.Master" AutoEventWireup="true" CodeBehind="UpdateEmployeePage.aspx.cs" Inherits="NeinteenFlowerProject.View.AdminPage.ManageEmployee.UpdateEmployeePage" %>
    ...
    <div class="container-form">
        <div class="form">
            ...
            <div>
                ...
                <asp:TextBox ID="passwordTxt" runat="server" CssClass="textBox" placeholder="Insert your password" ></asp:TextBox>
        ...
        <div class="img-updateEmployee"></div>
    </div>
</asp:Content>
