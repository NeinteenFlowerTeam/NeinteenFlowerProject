    ...
    <div class="container-form">
        <div class="form">
            ...
            <div>
                ...
                <asp:DropDownList ID="dlType" runat="server" CssClass="textBox"></asp:DropDownList>
            ...
            <asp:Button ID="btnSubmit" runat="server" Text="Insert Flower" OnClick="btnSubmit_Click" CssClass="welcomeBtn" />
        </div>
        <div class="img-insertFlower"></div>
    </div>
</asp:Content>
